...
Organizations face enormous pressure to drive down costs by maximizing spatial utilization in workplaces. But this is generally perceived as taking away what occupants need to be productive in exchange for cost savings by operators. Moreover, there are risks in pushing this too hard such that it damages occupant comfort, productivity and satisfaction. This paper showcases 'Spacematch' - an artificial intelligence driven platform that merges real-time personal environmental preferences of occupants, indoor environmental quality data and physical space data to improve occupant comfort and spatial utilization of workplaces. This new approach connects occupants with a catalog of available work desks, enables them to provide environmental feedback easily during use and supports the operations staff to optimize efficiency of comfort creation systems (HVAC, lighting, etc.) and space, by grouping occupants with similar preferences. The approach study also covers a pilot implementation with 25 research participants over a month at a university campus - and shares the challenges faced during implementation as well as the next steps in the advanced development of the platform.
...
Workplaces today face challenges of rising real estate costs as operators look to offset rentals by growing occupant headcount within their existing footprint. Equally, rapid changes in technology and nature of work in the the past few years have led organizations to rethink spatial density and utilization in workplaces. 

But to quantify workplace occupant density and space utilization, operators largely continue the use of "static" approaches such as cost or space per square feet dedicated to a workstation or an occupant. This is problematic, as static measures generally result in taking away amenities which make occupants comfortable, satisfied and productive in their work environments - like replacement of cubicles or L-shaped desks with benches, removing informal collaboration spaces and replacing them with desks and taking away storage space. Taking away such amenities in exchange for more spatial efficiency or cost savings is usually perceived as a quick fix method by operators with least regard to wellbeing of occupants {need reference}.

New and dynamic ways of working are also evolving in response to these challenges. These new ways of working, simultaneously balance a building operator's demands with the needs of the occupants through enabling occupant mobility in workplaces. Through these approaches the occupant is able to work flexibly through choosing different places within the workplace rather than being assigned a fixed desk as the one primary place of work. Once occupants are dynamic in the ways they use space, its easier to recapture underutilized spaces. When executed well, this improves the real estate bottom line whilst enhancing overall occupant comfort, productivity and satisfaction {need reference}. 

Workplace strategies of the kind are referred to differently by industry stakeholders, such as hot-desking, co-working, desk sharing, flexible working, activity based working and so on. Though each strategy varies slightly from the other in their offering - most promise benefits of improved spatial utilization and cost savings for operators while increasing overall comfort, control and choice for occupants \citep{Engelen2018IsReview}. Equally, a large recent survey of co-working spaces showed that one of the main motivations for people to work in a co-working space are that a workplace outside their home allows access to an inspiring work environment where the accommodation is affordable \citep{Weijs-Perree2018AnalysingCharacteristics}.
...
Despite the advantages, these approaches have some drawbacks. A study focused on a sociological analysis of one approach has shown a "loss of everyday ownership of the work space gives rise to particular practical and social tensions and shifts hot-deskers’ identification with the organization \cite{Hirst2011SettlersHot-desking}." Another study found lower than expected satisfaction with Activity based working environments due to many works rarely switching between different activity settings \citep{Hoendervanger2016FlexibilityEnvironments}. 

As organizations grow rightfully nervous of ill-conceived implementation of these new strategies to workplaces, they look for solutions to balance cost savings through spatial utilization while providing choice, comfort and ability to enhance enjoyment and performance at workplaces for occupants.   
