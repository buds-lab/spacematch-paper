...
Organizations face enormous pressure to drive down rental costs by maximizing spatial utilization in workplaces. But ill-conceived implementation of this strategy generally results in taking away what occupants need to be comfortable in exchange for cost savings by operators. Moreover, there are risks in pushing this too hard such that it damages occupant comfort, productivity and satisfaction. This paper showcases 'Spacematch' - an artificial intelligence driven platform that merges real-time personal environmental preferences of occupants, indoor environmental quality and physical space data to improve occupant comfort and spatial utilization of workplaces. This new approach connects occupants with a catalog of available work desks, enables them to easily provide environmental feedback during use and supports the operations staff to optimize efficiency of comfort creation systems (HVAC, lighting, etc.) and space, by grouping occupants with similar preferences. The study covers a pilot implementation with 25 research participants over a month at a university campus - and shares the challenges faced during implementation as well as the next steps in the advanced development of the platform.
