...
\begin{figure}[H]
\centering
\includegraphics[scale=0.08]{figures/pilot-01.jpg}
\caption{The six flexible working zones for pilot implementation: (a)Photos and map showing \emph{zone-1} on level 6, Building A, (b)\emph{zone-2} on level 6, Building A,  (c)\emph{zone-3} on level 6, Building A,  (d)\emph{zone-4} on level 3, Building A, (e)\emph{zone-5} on level 2, Building B, (f)\emph{zone-6} on level 2, Building B}
\label{pilot}
\end{figure}
