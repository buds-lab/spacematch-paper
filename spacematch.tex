...
\caption{The six flexible working zones for pilot implementation: (a)Photos and map showing \emph{zone-1} on level 6, Building 1, (b)\emph{zone-2} on level 6, Building 1,  (c)\emph{zone-3} on level 6, Building 1,  (d)\emph{zone-4} on level 3, Building 1, (e)\emph{zone-5} on level 2, Building 2, (f)\emph{zone-6} on level 2, Building 2 (g) Floor plans showing the location of flexible working zones in building 1 \& 2 \emph{from Left to right}: Building 1 - level 6 \& level 3; Building 2 - Level 2}
\label{pilot}
\end{figure}
