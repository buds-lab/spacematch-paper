...
This study addresses each of the previously mentioned challenges: enabling collection of personalized data in larger volume and with greater frequency in an easy and scalable way, way that is easy for operators and useful to occupants, reducing the need for complex and problematic personalized comfort systems, and impacting the growing trend of flexible work spaces in the building industry. 
