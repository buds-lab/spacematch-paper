...
The flexible workplace paradigm is rapidly maturing. This workplace strategy drives down rental costs and cost per occupant by improving spatial utilization - but studies have reported that its impact on occupant satisfaction is not always positive. One way to tackle this is to increase the frequency and volume of occupant feedback in buildings. However, frequently collecting occupant preferences using traditional human feedback collection methods such as surveys, interviews presents significant challenges. This paper showcases 'Spacematch' - a web based platform for easy collection of individual comfort preferences in flexible workplaces to improve environmental comfort and spatial utilization. This new approach connects occupants with a catalog of available work desks using a mobile application, enables them to easily provide environmental feedback in real-time, and facilitates merging this feedback data with indoor environmental values, from fixed room sensors, to optimize space and energy use by grouping occupants with similar preferences. The study covers a pilot implementation of the initial version of the platform at the National University of Singapore(NUS). 1182 responses from 25 research participants over a month were collected. This paper shares development methodology, challenges faced during implementation, the analysis results and the next steps in the platform's advanced development.
...
\begin{figure}
\centering
\includegraphics[scale=0.3]{figures/Untitled-1-01.png}
