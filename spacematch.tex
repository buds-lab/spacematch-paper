...
\caption{The six flexible working zones for pilot implementation: (a)Photo, layout and environmental profile of \emph{zone-1} (b)\emph{zone-2}, (c)\emph{zone-3}, (d)\emph{zone-4} (e)\emph{zone-5}, (f)\emph{zone-6}
\label{pilot}
\end{figure}
