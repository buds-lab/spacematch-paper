...
Organizations face enormous pressure to drive down costs by maximizing spatial utilization in workplaces. But its implementation is generally perceived as taking away what occupants need to be productive in exchange for cost savings by operators. Moreover, there are risks in pushing this too hard such that it damages occupant comfort, productivity and satisfaction. This paper showcases 'Spacematch' - an artificial intelligence driven platform that merges real-time personal environmental preferences of occupants, indoor environmental quality data and physical space data to improve occupant comfort and spatial utilization of workplaces. This new approach connects occupants with a catalog of available work desks, enables them to easily provide environmental feedback during their use and supports the operations staff to optimize efficiency of comfort creation systems (HVAC, lighting, etc.) and space, by grouping occupants with similar preferences. The approach study also covers a pilot implementation with 25 research participants over a month at a university campus - and shares the challenges faced during implementation as well as the next steps in the advanced development of the platform.
...
\subsection{Collecting human comfort feedback data in buildings}
Researchers and building owners have started installing a wide range of Internet-of-Things (IoT) devices that can measure various environmental conditions such as light, noise, and particulates levels, in addition the conventional temperature and humidity metrics. 
